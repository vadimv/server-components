 ...
 */
public class DelegationApprovalBlock
        extends Block<DelegationApprovalView.ApprovalViewState, DelegationApprovalView.Decision> {
    ...
    public DelegationApprovalBlock(DelegationStore store) {
    ...
    protected void onIntent(DelegationApprovalView.Decision intent,
            ...
            lookup().publish(EventKeys.HIDE, DelegationApprovalBlock.class);
    }
