...
class PromptViewStateTests {
    ...
    class MessageDeduplication {
        ...
        void withMessage_adds_new_message() {
            ...
            var msg = new PromptBlock.Message(1, "hello", true);
        ...
        void withMessage_rejects_duplicate_id() {
            var msg1 = new PromptBlock.Message(1, "first", false);
            var state = new PromptView.PromptViewState(List.of(msg1));

            var msg2 = new PromptBlock.Message(1, "duplicate", false);
        ...
        void withMessage_allows_different_ids() {
            var msg1 = new PromptBlock.Message(1, "first", true);
            var state = new PromptView.PromptViewState(List.of(msg1));

            var msg2 = new PromptBlock.Message(2, "second", false);
            var updated = state.withMessage(msg2);
        ...
        void withMessage_preserves_order_of_existing_messages() {
            var msg1 = new PromptBlock.Message(1, "cmd", true);
            var msg2 = new PromptBlock.Message(2, "reply", false);
            var state = new PromptView.PromptViewState(List.of(msg1, msg2));

            var msg3 = new PromptBlock.Message(3, "cmd2", true);
    ...
    class OptimisticMessages {
        ...
        void message_updates_preserve_next_optimistic_id() {
            ...
            var updated = state.withMessage(new PromptBlock.Message(10, "reply", false))
    ...
    class UpdateLastSystemMessage {
        ...
        void replaces_last_system_message_text() {
            var state = new PromptView.PromptViewState(List.of(
                    new PromptBlock.Message(1, "cmd", true),
                    new PromptBlock.Message(2, "Thinking...", false)
            ));
        ...
        void preserves_message_id_on_update() {
            var state = new PromptView.PromptViewState(List.of(
                    new PromptBlock.Message(5, "original", false)
            ));
        ...
        void skips_user_messages_to_find_last_system() {
            var state = new PromptView.PromptViewState(List.of(
                    new PromptBlock.Message(1, "system1", false),
                    new PromptBlock.Message(2, "user1", true),
                    new PromptBlock.Message(3, "system2", false),
                    new PromptBlock.Message(4, "user2", true)
            ));
    ...
    class Ordering {
        ...
        void simulated_prompt_reply_navigate_flow_preserves_order() {
            ...
            var history = List.of(
                    new PromptBlock.Message(1, "show posts", true),
                    new PromptBlock.Message(2, "Thinking...", false),
                    new PromptBlock.Message(3, "Navigating...", false)
            );
            var state = new PromptView.PromptViewState(history);

            // Step 2: NEW_MESSAGE arrives for a message already in history (dedup)
            var duplicate = new PromptBlock.Message(3, "Navigating...", false);
            ...
            var newReply = new PromptBlock.Message(4, "Done!", false);
