 ...
 * <p>
 * Each parser converts an {@link ContractActionPayload} (wrapping a {@link JsonDataType})
...
public final class PayloadParsers {
     ...
     */
    public static Function<ContractActionPayload, Object> toInteger() {
        return payload -> {
     ...
     */
    public static Function<ContractActionPayload, Object> toStringPayload() {
        return payload -> {
            JsonDataType value = payload.value();
     ...
     */
    public static Function<ContractActionPayload, Object> toSetOfStrings() {
        return payload -> {
            JsonDataType value = payload.value();
     ...
     */
    public static Function<ContractActionPayload, Object> toMapOfStringObject() {
        return payload -> {
            JsonDataType value = payload.value();
