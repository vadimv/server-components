...
public final class PayloadSchemas {
     ...
     * The returned function converts an {@link ContractActionPayload} to the type expected by the event key.
     */
    public static Function<ContractActionPayload, Object> toParser(PayloadSchema schema) {
