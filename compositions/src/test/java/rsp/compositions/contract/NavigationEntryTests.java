    ...
    class FromCompositionsTests {
        ...
        void label_comes_from_metadata_title() {
            final Composition comp = new Composition(
                    ...
                    new Contracts()
                            .bind(TestEntityContract.class, TestEntityContract::new, () -> null)
            );
        ...
        void deduplicates_by_category_key() {
            ...
            final Composition comp = new Composition(
                    ...
                    new Contracts()
                            .bind(TestListContract.class, TestListContract::new, () -> null)
                            .bind(TestListContract2.class, TestListContract2::new, () -> null)
            );
        ...
        void ignores_contracts_without_routes() {
            final Composition comp = new Composition(
                    new Router(),
                    new Contracts()
                            .bind(TestOverlayContract.class, TestOverlayContract::new, () -> null)
                            .bind(TestSidebarContract.class, TestSidebarContract::new, () -> null)
            );
        ...
        void does_not_require_contract_instantiation() {
            final Composition comp = new Composition(
                    new Router()
                            ...
                            .route("/items", TestListContract.class),
                    new Contracts()
                            .bind(FailingContract.class, FailingContract::new, () -> null)
                            .bind(TestListContract.class, TestListContract::new, () -> null)
            );
