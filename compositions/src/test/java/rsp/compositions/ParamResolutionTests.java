...
public class ParamResolutionTests {
    ...
    class QueryParamTests {
        ...
        void resolve_extracts_from_url_query_dynamic_key() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_QUERY.with("search"), "test");
            final QueryParam<String> param = new QueryParam<>("search", String.class, null);

            final String result = param.resolve(context);
        ...
        void resolve_applies_integer_type_conversion() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_QUERY.with("page"), "42");
            final QueryParam<Integer> param = new QueryParam<>("page", Integer.class, 1);

            final Integer result = param.resolve(context);
        ...
        void resolve_applies_long_type_conversion() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_QUERY.with("id"), "9876543210");
            final QueryParam<Long> param = new QueryParam<>("id", Long.class, 0L);

            final Long result = param.resolve(context);
        ...
        void resolve_applies_boolean_type_conversion() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_QUERY.with("enabled"), "true");
            final QueryParam<Boolean> param = new QueryParam<>("enabled", Boolean.class, false);

            final Boolean result = param.resolve(context);
        ...
        void resolve_uses_default_when_null() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_QUERY.with("nullable"), null);
        ...
        void resolve_string_value_for_string_param() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_QUERY.with("name"), "John");
        ...
        void resolve_with_custom_converter() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_QUERY.with("status"), "ACTIVE");
            ...
            final Status result = param.resolve(context);
    ...
    class PathParamTests {
        ...
        void resolve_extracts_from_url_path_dynamic_key() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_PATH.with("1"), "posts");
        ...
        void resolve_applies_integer_type_conversion() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_PATH.with("2"), "123");
        ...
        void resolve_applies_long_type_conversion() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_PATH.with("1"), "9999999999");
        ...
        void resolve_with_custom_converter() {
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_PATH.with("1"), "PENDING");
        ...
        void resolve_multiple_path_segments() {
            ...
            final ComponentContext context = new ComponentContext()
                    .with(ContextKeys.URL_PATH.with("0"), "posts")
                    .with(ContextKeys.URL_PATH.with("1"), "42")
                    .with(ContextKeys.URL_PATH.with("2"), "comments")
                    .with(ContextKeys.URL_PATH.with("3"), "7");
            ...
            assertEquals(42, postId.resolve(context));
            assertEquals(7, commentId.resolve(context));
        }
    }
    ...
    class DefaultValueTests {
        ...
        void query_param_default_can_be_null() {
            ...
            assertNull(param.resolve(context));
        }
        ...
        void query_param_default_can_be_zero() {
            ...
            assertEquals(0, param.resolve(context));
        }
        ...
        void query_param_default_can_be_empty_string() {
            ...
            assertEquals("", param.resolve(context));
        }
        ...
        void path_param_default_can_be_negative() {
            ...
            assertEquals(-1, param.resolve(context));
        }
    }
