...
/**
 * Tests for DataSchema record introspection and transformation.
 */
public class DataSchemaTests {
    ...
    class FromRecordClassTests {
        ...
        void extracts_all_record_components() {
            final DataSchema schema = DataSchema.fromRecordClass(SimpleRecord.class);
        ...
        void preserves_field_order() {
            final DataSchema schema = DataSchema.fromRecordClass(TypedRecord.class);

            final List<String> names = schema.columns().stream()
                    .map(DataSchema.ColumnDef::name)
                    .toList();
        ...
        void captures_correct_types() {
            ...
            final Map<String, Class<?>> typesByName = schema.columns().stream()
                    .collect(java.util.stream.Collectors.toMap(
                            DataSchema.ColumnDef::name,
                            DataSchema.ColumnDef::type
                    ));
        ...
        void throws_on_non_record_class() {
            assertThrows(IllegalArgumentException.class, () ->
                DataSchema.fromRecordClass(String.class)
            );
        }
        ...
        void handles_empty_record() {
            ...
            final DataSchema schema = DataSchema.fromRecordClass(EmptyRecord.class);
    ...
    class FromFirstItemTests {
        ...
        void extracts_schema_from_instance() {
            ...
            final DataSchema schema = DataSchema.fromFirstItem(item);
        ...
        void handles_null_item() {
            final DataSchema schema = DataSchema.fromFirstItem(null);
    ...
    class SchemaCustomizationTests {
        ...
        void rename_column_changes_display_name() {
            final DataSchema original = DataSchema.fromRecordClass(SimpleRecord.class);

            final DataSchema renamed = original.renameColumn("id", "Identifier");
        ...
        void hide_column_removes_from_schema() {
            ...
            final DataSchema hidden = original.hideColumn("id");
        ...
        void hide_column_non_existent_no_change() {
            ...
            final DataSchema hidden = original.hideColumn("nonexistent");
        ...
        void reorder_columns_changes_order() {
            ...
            final DataSchema reordered = original.reorderColumns("name", "id");
        ...
        void reorder_columns_with_subset_only_includes_specified() {
            final DataSchema original = DataSchema.fromRecordClass(TypedRecord.class);

            final DataSchema reordered = original.reorderColumns("price", "id");
    ...
    class DisplayNameFormattingTests {
        ...
        void simple_field_capitalized_first_letter() {
            final DataSchema.ColumnDef col = new DataSchema.ColumnDef("name", String.class);
        ...
        void camel_case_converted_to_title_case() {
            final DataSchema.ColumnDef col = new DataSchema.ColumnDef("firstName", String.class);
        ...
        void multiple_camel_case_words() {
            final DataSchema.ColumnDef col = new DataSchema.ColumnDef("dateOfBirth", String.class);
        ...
        void single_character() {
            final DataSchema.ColumnDef col = new DataSchema.ColumnDef("x", String.class);
        ...
        void acronym_style_spaced_correctly() {
            final DataSchema.ColumnDef col = new DataSchema.ColumnDef("userID", String.class);
