...
| `ui-http` | Initial-page and resumable RSP adapters over the generic JDK server | `ui-core`, `http-api`, `websocket-api`, `server-jdk`; `js-client` at runtime | Direct for the built-in UI server |
