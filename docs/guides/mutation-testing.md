...
> covering tests against each in a fresh JVM, and prints a survivor report you read by hand. See
> the [testing guide](testing.md) for where mutation testing fits in the repository's test suite.
