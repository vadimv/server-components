...
class QueryTests {
    ...
    @Test
    void preserves_duplicate_parameters_in_order() {
        Query query = Query.parse("tag=java&tag=http&tag=ui");

        assertEquals(List.of("java", "http", "ui"), query.parameterValues("tag"));
    }
