...
final class HttpRequestParser {
    ...
    Optional<ParsedHttpRequest> parse(final Socket socket, final String scheme) throws IOException, HttpProtocolException {
        ...
        final String rawPath = requestUri.getRawPath() == null || requestUri.getRawPath().isEmpty()
        ...
        final HttpRequest request = new HttpRequest(requestLine.method(),
                                                    ...
                                                    Path.parse(rawPath),
                                                    query,
                                                    HttpHeaders.copyOf(headers),
                                                    RequestBody.of(body, MAX_FORM_BODY_BYTES));
    ...
    private List<HttpHeader> parseHeaders(final String[] lines) throws HttpProtocolException {
    ...
    private int contentLength(final List<HttpHeader> headers) throws HttpProtocolException {
    ...
    private static String header(final List<HttpHeader> headers, final String name) {
