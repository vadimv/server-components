 ...
 * <p>
 * Each parser converts an {@link BlockActionPayload} (wrapping a {@link JsonDataType})
...
public final class PayloadParsers {
     ...
     */
    public static Function<BlockActionPayload, Object> toInteger() {
        return payload -> {
     ...
     */
    public static Function<BlockActionPayload, Object> toStringPayload() {
        return payload -> {
            JsonDataType value = payload.value();
     ...
     */
    public static Function<BlockActionPayload, Object> toSetOfStrings() {
        return payload -> {
            JsonDataType value = payload.value();
     ...
     */
    public static Function<BlockActionPayload, Object> toMapOfStringObject() {
        return payload -> {
            JsonDataType value = payload.value();
