...
public final class PayloadSchemas {
     ...
     * The returned function converts an {@link BlockActionPayload} to the type expected by the event key.
     */
    public static Function<BlockActionPayload, Object> toParser(PayloadSchema schema) {
