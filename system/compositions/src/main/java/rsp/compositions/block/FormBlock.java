...
/**
 * Intent-driven base for create and edit blocks.
 *
...
public abstract class FormBlock<T>
    ...
    protected void onBlockMounted(EditView.EditViewState state,
        ...
        subscribe(FormBlockEvents.FORM_SUBMITTED,
    ...
    public List<BlockAction> agentActions() {
        return List.of(
                new BlockAction("set_field", FormBlockEvents.FORM_FIELD_SET,
                ...
                new BlockAction("save", FormBlockEvents.FORM_SUBMITTED,
                        "Submit form data", PayloadSchemas.fromDataSchema(schema()), DispatchEffect.SCENE_CHANGE),
                new BlockAction("cancel", FormBlockEvents.CANCEL_REQUESTED,
    ...
    public BlockMetadata blockMetadata() {
        ...
        return new BlockMetadata(title(), description, schema(), state);
    }
